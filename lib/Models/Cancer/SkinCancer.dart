...
import 'ResultCancer/Result_Cancer.dart';
...
class _SkinCancerState extends State<SkinCancer> {
  ...
  File? img;
  var url =
      "https://anwarkh1-anwarkh1-skin-cancer-image-classification.hf.space/predictApi";
    ...
    if (response.statusCode == 200) {
      ...
      if (resJson != null && resJson['Error'] != null) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ResultCancer(result: "", image: null)),
        );
      } else {
        ...
        if (result.isNotEmpty) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ResultCancer(result: result, image: img),
            ),
          );
        } else {
          Navigator.push(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Text(
                  'Choose an image',
                  style:
                      TextStyle(fontSize: 16.sp,color: Colors.white, fontWeight: FontWeight.w500,fontFamily: GoogleFonts.inter().fontFamily,),
                ),
              ),
            ],
          ),
